      ...
      <div className="alignRules">
        ...
        <div className="rulesDiv">
          <ol className="rulesInnerDiv">
            ...
            <li>Nu är det två nya spelares tur! Fortsätt spelet så länge ni vill!</li>
            <h3>Avsluta spelet:</h3>
            <li>När ni känner er klara tryck på meny knappen uppe i högra hörnet, tryck därefter på "Avsluta spel" och därefter på "Avsluta spel" igen."</li><br></br>
          </ol>
        </div>
      </div>
    </div>
